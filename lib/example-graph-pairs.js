...
exports["three conditionals"] = {
  a: q("a p c", "b p c", "c p d"),
  b: q("_:aa p _:cc", "_:bb p _:cc", "_:cc p _:dd"),
  a_entails_b: true,
  b_entails_a: false,
};

exports["multiple matches where one is invalid for *any* reason"] = {
  a: q("a p _:s", "a q _:t", "b p _:t", "_:s p o"),
  b: q("_:aa p _:ss", "_:aa q _:tt"),
  a_entails_b: true,
  b_entails_a: false,
};
...
exports[
  ...
  a: q("a  p _:s", "a  p _:t", "_:t  p o"),
  b: q("_:aa p _:ss", "_:ss p _:rr", "_:aa p _:rr"),
  a_entails_b: true,
  b_entails_a: false,
};
